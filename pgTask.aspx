<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="pgTask.aspx.cs" Inherits="WebApp.Interface.pgTask" %>
        ...
        <asp:Panel ID="pnAddTask" runat="server" CssClass="modalpopup">
            <table>
                ...
                <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTitle" runat="server" ReadOnly="false" Width="250px" Font-Names="Khmer OS System"></asp:TextBox>
                            </td>
                        </tr>
                ...
                <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlSeverity" runat="server" Width="258px" Height="28px" AutoPostBack="false"  >  </asp:DropDownList>
                            </td>
                        </tr>
                ...
                <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlPriority" runat="server" Width="258px" Height="28px" AutoPostBack="false"  >  </asp:DropDownList>
                            </td>
                        </tr>
                <tr>
                    <td></td>                    
        ...
        <table>
            ...
            <tr>
                <td>                                            
                    ...
                    <asp:GridView ID="dtgTask" runat="server" AutoGenerateSelectButton="false" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Font-Names="Microsoft Sans Serif" Font-Size="16px" OnRowDataBound="dtgTask_RowDataBound"  >             
        ...
        <asp:Panel ID="pnViewTask" runat="server" CssClass="modalpopup">
            <table>
                ...
                <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtViewTitle" runat="server" ReadOnly="false" Width="250px" Font-Names="Khmer OS System" ></asp:TextBox>
                            </td>
                        </tr>
                ...
                <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtViewDescription" runat="server" ReadOnly="false" TextMode="MultiLine"  Height="115px" Width="250px" Font-Names="Khmer OS System"></asp:TextBox>
                        </td>
                    </tr>
                ...
                <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlViewSeverity" runat="server" Width="258px" Height="28px" AutoPostBack="false"  >  </asp:DropDownList>
                            </td>
                        </tr>
                ...
                <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlViewPriority" runat="server" Width="258px" Height="28px" AutoPostBack="false"  >  </asp:DropDownList>
                            </td>
                        </tr>
                <tr>
                    <td></td>                    
                ...
                <tr>
                    <td colspan="2">
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnEdit" runat="server" Text="Edit"  CssClass="btnPopupPax" OnClick="btnEdit_Click"  />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnDelete" runat="server" Text="Delete"  CssClass="btnPopupPax" OnClick="btnDelete_Click"  />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<asp:Button ID="btnViewTask" runat="server" Text="Edit Bug" style="display:none" />
