...
"INSERT INTO tblPermission(\n\r" +
            ...
            "           ,null\r\n" +
            ") ; " +
"update tbTicketType set sort_order=@intChildID-1  where id=@intChildID-1 ; update tbTicketType set sort_order=@intChildID where id=@intChildID";
            try
            {
                SqlCommand sqlcom = sqlConn.CreateCommand();
                sqlcom.CommandText = strSQL;
